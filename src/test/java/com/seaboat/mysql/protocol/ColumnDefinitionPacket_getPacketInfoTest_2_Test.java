...
public class ColumnDefinitionPacket_getPacketInfoTest_2_Test {
  @Test
  public void getPacketInfoTest() throws Exception {
    ...
    // Act
    String actual = columnDefinitionPacket.getPacketInfo();

    // Assert
    Assert.assertEquals("MySQL Column Definition Packet", actual);
