...
public class QuitPacketTest {
  ...
  public void calcPacketSizeOutputPositive() {
    ...
    // Arrange
    final QuitPacket quitPacket = new QuitPacket();

    // Act and Assert result
    Assert.assertEquals(1, quitPacket.calcPacketSize());
  }
  ...
  public void readInput7OutputVoid() {
    ...
    // Act
    quitPacket.read(data);

    // The method returns void, testing that no exception is thrown
  }

  // Test written by Diffblue Cover.
  @PrepareForTest({QuitPacket.class, BufferUtil.class, ByteBuffer.class})
  @Test
